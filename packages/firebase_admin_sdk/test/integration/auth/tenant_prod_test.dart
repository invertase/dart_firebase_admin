...
void main() {
  group('TenantManager (Production)', () {
    group('createTenant - TOTP/MFA', () {
      test('creates tenant with TOTP provider config', () {
      ...
      test('creates tenant with both SMS and TOTP MFA', () {
        // Remove emulator env var from the zone environment
        final prodEnv = Map<String, String>.from(Platform.environment);
        prodEnv.remove(Environment.firebaseAuthEmulatorHost);
    ...
    group('updateTenant - TOTP/MFA', () {
      test('updates tenant with TOTP provider config', () {
        // Remove emulator env var from the zone environment
        final prodEnv = Map<String, String>.from(Platform.environment);
        prodEnv.remove(Environment.firebaseAuthEmulatorHost);
      ...
      test('updates tenant with combined SMS and TOTP MFA', () {
        // Remove emulator env var from the zone environment
        final prodEnv = Map<String, String>.from(Platform.environment);
        prodEnv.remove(Environment.firebaseAuthEmulatorHost);
    ...
    group('authForTenant - User Operations', () {
      test('tenant auth can create users', () {
        // Remove emulator env var from the zone environment
        final prodEnv = Map<String, String>.from(Platform.environment);
        prodEnv.remove(Environment.firebaseAuthEmulatorHost);
      ...
      test('tenant auth can list users', () {
        // Remove emulator env var from the zone environment
        final prodEnv = Map<String, String>.from(Platform.environment);
        prodEnv.remove(Environment.firebaseAuthEmulatorHost);
    ...
    group('authForTenant - Session Cookies', () {
      test('tenant auth creates and verifies a valid session cookie', () {
        // Remove emulator env var from the zone environment
        final prodEnv = Map<String, String>.from(Platform.environment);
        prodEnv.remove(Environment.firebaseAuthEmulatorHost);
      ...
      test('tenant auth creates a revocable session cookie', () {
        // Remove emulator env var from the zone environment
        final prodEnv = Map<String, String>.from(Platform.environment);
        prodEnv.remove(Environment.firebaseAuthEmulatorHost);
