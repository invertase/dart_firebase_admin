...
FirestoreError _createFirestoreError({
  ...
  if (isJson) {
    ...
    return FirestoreError.fromServerError(
...
class FirestoreError implements Exception {
  FirestoreError(this.errorCode, [String? message])
    : message = message ?? errorCode.message;

  @internal
  factory FirestoreError.fromServerError({
    ...
    return FirestoreError(error, effectiveMessage);
  }
