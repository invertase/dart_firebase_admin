...
class Transaction {
  ...
  ///
  /// Throws a [FirestoreError] with [FirestoreClientErrorCode.notFound] status if no document exists at the
  /// provided [docRef].
  ///
  ...
  /// [FirestoreError] with [FirestoreClientErrorCode.notFound].
  ///
  ...
  /// [precondition] is specified, in which case it throws a [FirestoreError] with [FirestoreClientErrorCode.notFound]).
  void delete(
...
bool _isRetryableTransactionError(FirestoreError error) {
