...
class Transaction {
  ...
  ///
  /// Throws a [FirestoreException] with [FirestoreClientErrorCode.notFound] status if no document exists at the
  /// provided [docRef].
  ///
  ...
  /// [FirestoreException] with [FirestoreClientErrorCode.notFound].
  ///
