...
void main() {
  if (!hasGoogleEnv) {
    // ignore: avoid_print
    print(
      'Skipping Explain production tests. '
      'Set GOOGLE_APPLICATION_CREDENTIALS environment variable to run these tests.',
    );
    return;
  }

  group('Query explain() [Production]', () {
  ...
  group('AggregateQuery explain() [Production]', () {
    late Firestore firestore;
    final collectionsToCleanup = <String>[];
