...
PACKAGE_DIR="$SCRIPT_DIR/../packages/googleapis_storage"
...
firebase emulators:exec --project dart-firebase-admin --only storage "dart run coverage:test_with_coverage -- --concurrency=1"
